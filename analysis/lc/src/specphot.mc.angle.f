...
c      integer iangle
      ...
      real*8 time,th,phi
      real*8 y(nn),y0(nn),yy(nn,nth)
      real*8 mags_bol(nth),mags_u(nth),mags_b(nth)
      real*8 mags_v(nth),mags_r(nth),mags_i(nth)
      real*8 mags_j(nth),mags_h(nth),mags_k(nth)
...
c      write(*,*) "iangle?"
c      read(*,*) iangle
      open(unit=61,status="new",file=
     &     "./lcresult/multilc.angle.bol.d")
      open(unit=62,status="new",file=
     &     "./lcresult/multilc.angle.u.d")
      open(unit=63,status="new",file=
     &     "./lcresult/multilc.angle.b.d")
      open(unit=64,status="new",file=
     &     "./lcresult/multilc.angle.v.d")
      open(unit=65,status="new",file=
     &     "./lcresult/multilc.angle.r.d")
      open(unit=66,status="new",file=
     &     "./lcresult/multilc.angle.i.d")
      open(unit=67,status="new",file=
     &     "./lcresult/multilc.angle.j.d")
      open(unit=68,status="new",file=
     &     "./lcresult/multilc.angle.h.d")
      open(unit=69,status="new",file=
     &     "./lcresult/multilc.angle.k.d")
...
c      read(52,*)
      ...
      do k=1,10000
         ...
         do m=1,nangle
            read(51,*,end=5000) time,th,phi
            read(51,*) (y0(i),i=1,nobj)
            do i=1,nobj
               y(i)=y(i)+y0(i)
            end do
...
c         end do
 ...
 5555    continue
         ...
         write(61,4000) time,(mags_bol(l),l=1,nth)
         write(62,4000) time,(mags_u(l),l=1,nth)
         write(63,4000) time,(mags_b(l),l=1,nth)
         write(64,4000) time,(mags_v(l),l=1,nth)
         write(65,4000) time,(mags_r(l),l=1,nth)
         write(66,4000) time,(mags_i(l),l=1,nth)
         write(67,4000) time,(mags_j(l),l=1,nth)
         write(68,4000) time,(mags_h(l),l=1,nth)
         write(69,4000) time,(mags_k(l),l=1,nth)

 4000    format(f7.2,2000(1x,f6.2))
